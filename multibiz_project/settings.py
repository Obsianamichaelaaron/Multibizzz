...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-multibiz-dev-only')
...
GOOGLE_DRIVE_FOLDER_ID = os.environ.get(
    ...
    '142yr98iPnLBJqg8WE6c-XKoScO_AFgix'
)
...
GOOGLE_DRIVE_OAUTH_CREDENTIALS_FILE = os.environ.get(
    ...
    str(BASE_DIR / 'client_secret_244236718785-cncc88lcudaqn13hao2d8phe0il7563r.apps.googleusercontent.com.json')
)
GOOGLE_DRIVE_OAUTH_TOKEN_FILE = os.environ.get(
    'GOOGLE_DRIVE_OAUTH_TOKEN_FILE',
    str(BASE_DIR / 'google-drive-token.json')
)
...
# File upload limits for resume/profile/media uploads.
# Keep this aligned with PythonAnywhere/OpenResty client_max_body_size settings.
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', f"Multibiz Intelligence <{EMAIL_HOST_USER}>" if EMAIL_HOST_USER else 'no-reply@multibiz.com')
SITE_URL = os.environ.get('SITE_URL', 'http://127.0.0.1:8000/')

# PythonAnywhere terminates HTTPS before forwarding requests to the WSGI app.
